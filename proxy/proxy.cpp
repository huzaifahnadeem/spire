...
int main(int ac, char **av) {
    ...
    temp_measure_switch_time("main(): before E_handle_events");
    ...
    temp_measure_switch_time("main(): after E_handle_events");
...
void SwitcherManager::handle_switcher_message(int sock, int code, void* data) {
    temp_measure_switch_time("SwitcherManager::handle_switcher_message: called");
    UNUSED(code);
    ...
    // temp_measure_switch_time("SwitcherManager::handle_switcher_message: before spines_recvfrom()");
